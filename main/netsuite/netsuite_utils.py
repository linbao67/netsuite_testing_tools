...
def create_soap_search_service(token_passport, endpoint, sync_start_time=None, sync_end_time=None,
                               internal_id=None):
    """
            Returns the xml part string of <type></type>
            Args:
                :param token_passport:
                :param sync_end_time:
    ...
    search_record = search_record_part(ep.ENDPOINTS_FIELDS[endpoint][ep.SEARCH],
                                       ...
                                       basic_search_criteria)
    soap_xml = search(search_record, _soapheaders={"tokenPassport": token_passport,
